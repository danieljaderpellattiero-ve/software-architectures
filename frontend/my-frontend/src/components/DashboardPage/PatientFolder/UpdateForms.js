...
const UpdateForms = ({ onSave, initialData = {} }) => {
  ...
  const handleMedicationChange = (index, field, value) => {
    ...
    // Clear medication errors when editing
  ...
  return (
    <div className="patient-dashboard">
      <PatientSidebar />
      <div className="updated-form-container">
        <form onSubmit={handleSubmit} className="profile-card">
          ...
          <div className="form-section medications-section">
            ...
            {formData.medications.map((medication, index) => (
              <div key={index} className="medication-row form-group">
                <input 
                  type="text"
            ...
            {errors.medications && (
              <p className="error-message">{errors.medications}</p>
            )}
            <button 
              type="button" 
