...
import ConfirmedPatientsIcon from '@/public/confirmedPatients.svg';
...
const DoctorSidebar = () => {
  ...
  const handleConfirmedPatientsNavigation = () => {
    setIsLoading(true);
    router.push("/doctorDashboard/confirmedPatients");
  };

  const handlePatientRequestsNavigation = () => {
    setIsLoading(true);
    router.push("/doctorDashboard/patientRequests");
  };
      ...
      <div className="fixed top-0 left-0 h-screen w-[120px] bg-[#6c4c94] flex flex-col items-center py-5 overflow-y-auto z-[100]">
        ...
        <div className="flex flex-col justify-between flex-1 w-full">
          <div className="flex flex-col items-center gap-5 mb-5">
            ...
            >
              <Image alt="confirmed patients " src={ConfirmedPatientsIcon} className="w-[40px] h-[40px]"/>
              <span className="text-white font-bold text-center">Confirmed </span>
            </button>
            <button
              onClick={handlePatientRequestsNavigation}
              className="p-2 hover:scale-110 hover:bg-[#9b7bbd] hover:cursor-pointer transition-all duration-300 rounded-lg"
            >
              <ClipboardDocumentListIcon className="w-[40px] h-[40px] text-white" />
              <span className="text-white font-bold text-center">  Requests</span>
            </button>
          </div>
          ...
          <div className="flex flex-col items-center gap-5 mb-5">
            <button
              ...
              className={`p-2 hover:scale-110 hover:bg-[#9b7bbd] transition-all duration-300 rounded-lg ${
